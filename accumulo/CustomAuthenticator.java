 ...
 * https://github.com/apache/incubator-slider/blob/develop/app-packages/accumulo/src/main/java/org/apache/slider/accumulo/CustomAuthenticator.java
 *
...
public final class CustomAuthenticator implements Authenticator {
  ...
  public void initializeSecurity(TCredentials credentials, String principal,
    ...
    try {
      pass = new String(getPassword(jksFile, ROOT_INITIAL_PASSWORD_PROPERTY));
